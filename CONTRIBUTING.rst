...
Report bugs at https://github.com/blackhc/llm-strategy/issues
...
https://github.com/blackhc/llm-strategy/issues.
...
Ready to contribute? Here's how to set up `llm-strategy` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `llm-strategy` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/llm-strategy.git
